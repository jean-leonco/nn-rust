...
/// Writes a `Range<usize>` as two consecutive 32-bit unsigned integers in little-endian format.
#[inline]
pub fn write_range(writer: &mut impl Write, value: Range<usize>) -> Result<(), SerializationError> {
...
/// Reads a `Range<usize>` as two consecutive 32-bit unsigned integers in little-endian format.
#[inline]
pub fn read_range(reader: &mut impl Read) -> Result<Range<usize>, SerializationError> {
